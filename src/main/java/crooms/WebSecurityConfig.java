...
//import crooms.domain.service.user.ReservationUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/js/**", "/css/**").permitAll().antMatchers("/**").authenticated().and()
				...
				.passwordParameter("password").defaultSuccessUrl("/contest/list", true).failureUrl("/loginForm?error=true")
				.permitAll();
	}
